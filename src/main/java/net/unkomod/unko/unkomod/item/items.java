...
public class items {
    ...
    public static Item SPECIAL_UNKO=new special_item(new FabricItemSettings());
    ...
    public static void Init(){
        ...
        Registry.register(Registries.ITEM,new Identifier(MOD_ID,"special_unko"),SPECIAL_UNKO);
